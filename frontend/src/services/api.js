...
export const aiAPI = {
  ...
  getTopicTests: () => request('/ai/topic-tests', 'GET', null, true), // Bypass cache to always show up-to-date test runs
  getTopicTest: (id) => request(`/ai/topic-tests/${id}`),
  submitTopicTest: (body) => request('/ai/topic-tests', 'POST', body),
